...
export default function TripCreateWizard({ onTripCreated, initialData }) {
  ...
  const [formData, setFormData] = useState(() => {
    ...
    if (initialData) {
      return {
        ...
        cities:
          initialData.cities && initialData.cities.length > 0
            ? initialData.cities
            : [
                {
                  id: Date.now(),
  ...
  const steps = [
    {
      id: 1,
      name: "Basic Info",
      description: "Trip title, description, and location",
    },
    { id: 2, name: "Dates & Budget", description: "When and how much" },
    {
      id: 3,
      name: "Preferences",
      description: "Tags, visibility, and group size",
    },
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      ...
      console.log(
        "🔐 Session check:",
        session?.user?.id ? "User logged in" : "No user session"
      );
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-500">
                    Upload a cover image for your trip (optional, max 10MB)
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                Once created, you can add itinerary items, invite members, and
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start p-6 sm:p-8 lg:p-12">
            <div className="max-w-2xl">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-white/90 mb-6 sm:mb-8 leading-relaxed">
                Plan the perfect group trip and connect with fellow travelers on
                your next adventure
              </p>
