...
export default function Home() {
  ...
  <div className="relative overflow-hidden pt-10 sm:pt-14 flex-1 flex items-center">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div className="text-center lg:text-left">
              {/* <div className="mx-auto inline-flex items-center rounded-full px-4 py-2 text-sm font-medium text-sky-900 bg-gradient-to-r from-sky-100 via-fuchsia-100 to-purple-100 shadow-sm">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-lg sm:text-xl text-gray-600">
              ...
              <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center lg:justify-start">
                <Link
                  href="/explore"
                  className="group relative inline-flex items-center justify-center rounded-full bg-gradient-to-r from-sky-600 via-fuchsia-600 to-purple-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:brightness-110 hover:-translate-y-0.5"
                >
                ...
                {!loading && !user && (
                  <Link
                    href="/auth"
                    className="inline-flex items-center justify-center rounded-full border border-gray-200 bg-white px-8 py-4 text-lg font-semibold text-gray-800 shadow-lg transition-all hover:bg-gray-50 hover:-translate-y-0.5"
                  >
            ...
            <div className="relative order-first -mb-6 sm:-mb-10 lg:order-none lg:mb-0">
              <div className="relative mx-auto aspect-square w-5/6 max-w-lg overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 via-fuchsia-100 to-purple-100 shadow-2xl ring-1 ring-white/60">
                ...
                <Image src="/landing.png" alt="Trip planning preview" fill priority className="object-cover object-center" />
              </div>
          ...
          <div className="mt-14 flex flex-col items-center gap-4 mb-20">
