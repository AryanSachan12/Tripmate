            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-xl sm:text-2xl font-bold text-gray-900">
                      {userTrips.filter(trip => trip.status !== 'completed' && trip.status !== 'cancelled').length}
                    </p>
                    <p className="text-sm sm:text-base text-gray-600">Active Trips</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm sm:text-lg font-bold text-gray-900">Coming Soon</p>
                    <p className="text-sm sm:text-base text-gray-600">Travel Buddies</p>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2 text-right">
                          <div className="flex flex-col space-y-1">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(trip.status || 'upcoming')}`}>
                              {trip.status || 'Upcoming'}
                            </span>
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getRoleColor(trip.userRole || trip.memberRole || 'Traveller')}`}>
